...
package.domain = com.totuccio

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (let empty to include all the files)
source.include_exts = py,pyc,pyd,kv,atlas,otf,db
...
source.exclude_patterns = *pycache*
...
version.filename = %(source.dir)s/core/gamemech.py
...
presplash.filename = %(source.dir)s/img/default

# (str) Icon of the application
#icon.filename = %(source.dir)s/data/icon.png
icon.filename = %(source.dir)s/img/soul
...
#
author = © Copyright totuccio

# change the major version of python used by the app
osx.python_version = 3.8.1
